  ...
  if (answer) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center p-4 text-center gradient-bg relative overflow-hidden">
        ...
        I knew it😭 It's ok. The way you paired that flower dress with your shoes so beautifully, I probably would've frozen up like that other sunday and said nothing again.
        </h3>
      </main>
    );
  }
